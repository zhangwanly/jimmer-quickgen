...
/**
 * Post-processes Java source strings generated by JavaPoet.
 *
 * <p>Applies two transformations:</p>
 * <ul>
 *   <li>{@link #compactAnnotations(String)} — collapses multi-line annotations into single-line form</li>
 *   <li>{@link #groupImports(String)} — groups imports in IDEA default style</li>
 * </ul>
 */
final class SourcePostProcessor {

    private SourcePostProcessor() {}
